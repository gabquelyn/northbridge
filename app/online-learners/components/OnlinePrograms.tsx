        ...
        >
          <div className="flex flex-col items-start gap-3 p-6 bg-gray-50 rounded-3xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-700 text-[.9rem] leading-relaxed">
              Academic programs are carefully designed to ensure learners meet
              Ontario curriculum expectations and build foundational skills for
              success.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start gap-3 p-6 bg-gray-50 rounded-3xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-700 text-[.9rem] leading-relaxed">
              Students gain academic upgrading, familiarity with Canadian-style
              learning systems, and the confidence to transition into
              post-secondary education seamlessly.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start gap-3 p-6 bg-gray-50 rounded-3xl shadow-md hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-700 text-[.9rem] leading-relaxed">
              Program can be delivered onsite or fully online, offering global
              accessibility and flexibility, so students can prepare without
              returning to a traditional classroom environment
            </p>
          </div>
        </motion.div>
