...
export default function Structure() {
  return (
    <div className="bg-[#479DA5] flex flex-col gap-6 items-center justify-center p-5 py-20 pt-25">
      <p className="text-[2rem] md:text-[2.5rem] text-white font-bold text-center">
      ...
      <Link href="/consultation">
        <motion.button
          className={
            "text-[#68b2b9] bg-[#010A1D] rounded-3xl font-bold p-2 px-8"
          }
      ...
      <div className="flex gap-5 md:-mt-14 mt-5">
        ...
        <div className="relative hidden md:flex h-100 w-120 overflow-hidden rounded-md">
          <Image
            alt=""
